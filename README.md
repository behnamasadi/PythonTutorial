...
- [Metrics and Scoring For Model Evaluation](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Precision, Recall (Sensitivity / TPR), Accuracy](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [F1 Score / Sørensen–Dice Coefficient, Harmonic Mean](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [IoU (Jaccard), Hard vs Soft Dice/IoU](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [False Positive Rate (Fall-out / False Alarm Rate, Specificity)](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [mAP (mean Average Precision) — object detection, mAP@0.5 vs mAP@\[.5:.95\]](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [mAA (mean Average Accuracy) — pose / SfM estimation, mAP vs mAA](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Regression Metrics (MAE, MSE, RMSE, R², MAPE, Huber)](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Confusion Matrix (binary & multi-class, TP, FP, TN, FN)](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Macro vs Micro vs Weighted averaging](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Bias–Variance Tradeoff](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [ROC, AUC, PR-AUC (Average Precision) vs ROC-AUC](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Model Diagnostics: Learning Curves, Validation Curves, Cross-Validation, Top-K Accuracy](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)  
  * [Deep Learning Metric Decision Tree](machine_learning/metrics_and_scoring_for_model_evaluation/metrics_and_scoring_methods.ipynb)
