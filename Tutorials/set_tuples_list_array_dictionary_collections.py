...
print("############################### Array ###############################")
'If all you`re doing is creating arrays of simple data types and doing I/O, the array module will do just fine. If,' \
' on the other hand, you want to do any kind of numerical calculations,'
...
print("############################### append(), extend(), insert (i,x) , remove(),zip ###############################")
...
#use get() key instead of [] if you are not sure about teh exsitance of key 
print( my_dict.get("jumbo") )
print(my_dict.get("jumbo","key not found!"))



print("############################### dictionary from a lists ###############################")
list1= (['a', 1, 'b', 2, 'c', 3]) 
...
print("############################### dictionary duplicate key ###############################")
dictionary1 = {'GFG' : 1, 
               'Google' : 2, 
               'GFG' : 3
               } 
...
print("#################################### cloning/ copying/ deep cop ####################################")
